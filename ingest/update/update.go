...
func DownloadImage(r *http.Request) string {
	...
	jpgpath := filepath.Join("..", "jpg_update")
...
func Register_DownloadPatient(r *http.Request) {
	...
	patientpath := filepath.Join("..", "patient_update")
	...
	//readFile.ReadJSONForUpdate("patient_update")
}
...
func Register_DownloadAllergy(r *http.Request) {
	...
	patientpath := filepath.Join("..", "allergy_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("allergy_update")
}
...
func Vaccine_DownloadVaccination(r *http.Request) {
	...
	patientpath := filepath.Join("..", "vaccine_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("vaccine_update")
}
...
func Diet_DownloadBodyMeasurement(r *http.Request) {
	...
	patientpath := filepath.Join("..", "bodymeasurement_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("bodymeasurement_update")
}
...
func Diet_DownloadMealPlan(r *http.Request) {
	...
	patientpath := filepath.Join("..", "mealplan_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("mealplan_update")
}
...
func AE_DownloadAssessment(r *http.Request) {
	...
	patientpath := filepath.Join("..", "assessment_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("assessment_update")
}
...
func ChestPain_DownloadChestPain(r *http.Request) {
	...
	patientpath := filepath.Join("..", "chestpain_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("chestpain_update")
}
...
func PCI_DownloadRiskFactor(r *http.Request) {
	...
	patientpath := filepath.Join("..", "riskfactor_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("riskfactor_update")
}
...
func PCI_DownloadProcedure(r *http.Request) {
	...
	patientpath := filepath.Join("..", "procedure_update")
	err = os.MkdirAll(patientpath, os.ModePerm)
	if err != nil {
		log.Println("Creating json directory for patient encounters error")
		log.Println(err)
	...
	attachment = append(attachment, patient_file_path)
	email.SendEmailViaAWS(recipient, attachment...)
	//readFile.ReadJSONForUpdate("procedure_update")
}
