...
// func ReadAESKey(keyFile string) *pem.Block {
// 	var log = logger.BlockchainLog
...
// 	log.Println("Reading Encrypt AES Key : ", encrypt_key_block.Bytes)
// 	return encrypt_key_block
// }
...
func ReadPrivateKey(keyFile string) *rsa.PrivateKey {
	...
	log.Println("The private key path is :")
	log.Println(keyFile)
